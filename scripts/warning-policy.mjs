...
const RULES = [
  ...
  rule("messaging.unresolved-event-grid-topic", /\btopic of .+ could not be resolved from the Event Grid client constructor\b/i, "warning", "Construct the Event Grid publisher with a literal, constant, configuration default, or visible caller argument for its endpoint and namespace topic."),
