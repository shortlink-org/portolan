...
// startup and nothing else is asked of it. Each aggregate keeps its own
// directory, so the caller applies them in dependency order - the shipment's
// tables first, because a stop refers to a package.
