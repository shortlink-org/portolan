...
const DROP =
  /^(db\.query\.parameter\.|pgx\.query\.parameters$|db\.query\.text$|db\.statement$|http\.request\.header\.|http\.response\.header\.|url\.full$|url\.query$|user_agent\.original$|client\.address$)/;
