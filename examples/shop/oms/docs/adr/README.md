# Decision records — oms

| ADR | Title | Status | Date |
| --- | --- | --- | --- |
| [oms.0001](0001-rust-on-tokio.md) | Rust on Tokio, and the stack around it | accepted | 2026-09-05 |
| [oms.0002](0002-an-order-is-placed-from-a-checked-out-basket.md) | An order is placed from a checked-out basket, not by a call | accepted | 2026-09-05 |
