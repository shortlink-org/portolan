...
pub mod payment_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("payments.v1.PaymentService", "Authorize"));
...
pub mod payment_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/payments.v1.PaymentService/Authorize" => {
                    ...
                    struct AuthorizeSvc<T: PaymentService>(pub Arc<T>);
                    impl<
                        T: PaymentService,
                    ...
                    for AuthorizeSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as PaymentService>::authorize(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "payments.v1.PaymentService";
