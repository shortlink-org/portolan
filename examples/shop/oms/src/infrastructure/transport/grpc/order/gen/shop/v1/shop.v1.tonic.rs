...
pub mod order_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("shop.v1.OrderService", "GetOrder"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/shop.v1.OrderService/CancelOrder",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("shop.v1.OrderService", "CancelOrder"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod order_service_server {
    ...
    pub const SERVICE_NAME: &str = "shop.v1.OrderService";
