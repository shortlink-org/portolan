...
/// What the manifest tells the extractor: the things an application does not
/// say about the estate it belongs to. The same options as extract-django,
/// less the ones Django's settings answer.
#[derive(Debug, Default, Clone, Deserialize)]
