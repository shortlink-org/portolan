...
var catalogCoverage = map[reflect.Type]string{
	...
	reflect.TypeOf(catalog.Service{}):              "id slug name repo path readme kind technologies provides consumes dependsOn copies aggregates stores modules channels owners commands hosts gatewayExposures dials",
	reflect.TypeOf(catalog.GatewayExposure{}):      "id hostnames routeKind routeNamespace routeName gatewayNamespace gatewayName listener protocol port backendNamespace backendName basis source drift",
	reflect.TypeOf(catalog.GatewayExposureDrift{}): "hostnames protocol port",
	...
	reflect.TypeOf(catalog.SchemaField{}):          "name type",
	...
	reflect.TypeOf(catalog.Flow{}):                 "id slug name summary source trigger entrypoint includes composition owner participants steps examples",
	reflect.TypeOf(catalog.FlowComposition{}):      "flow source seam",
	reflect.TypeOf(catalog.FlowCompositionSeam{}):  "afterStep kind target basis confidence",
	...
	reflect.TypeOf(catalog.Participant{}):          "id kind context label entityRef",
