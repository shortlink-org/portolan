...
var catalogCoverage = map[reflect.Type]string{
	...
	reflect.TypeOf(catalog.Service{}):          "id slug name repo path readme kind technologies provides consumes aggregates stores modules channels owners commands",
	...
	reflect.TypeOf(catalog.RedisKeyspace{}):    "pattern operations ttl value source",
	...
	reflect.TypeOf(catalog.Step{}):             "type id from to kind ref label status note line replyTo http continuesAt reaches handoff",
