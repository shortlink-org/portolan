...
var catalogCoverage = map[reflect.Type]string{
	...
	reflect.TypeOf(catalog.Flow{}):             "id slug name summary source trigger entrypoint owner participants steps",
	reflect.TypeOf(catalog.FlowTrigger{}):      "kind label confidence",
	reflect.TypeOf(catalog.Participant{}):      "id kind context label",
	reflect.TypeOf(catalog.Step{}):             "type id from to kind ref label status note line continuesAt",
