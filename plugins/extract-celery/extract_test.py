...
class Drift(unittest.TestCase):
    ...
    def test_a_task_sent_by_name_to_another_tree_is_a_send_with_no_handler(self):
        ...
        self.assertEqual([f["slug"] for f in self.fragment["flows"]], ["reports-celery-build-report", "reports-celery-deliver-report"])
