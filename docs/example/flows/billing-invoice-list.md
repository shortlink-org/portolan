...
1. **client** → **shop.billing** — invoice_list
   `shop.billing.invoices/invoice_list` · status: declared · [`examples/shop/billing/invoices/views.py:10`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/billing/invoices/views.py#L10)
