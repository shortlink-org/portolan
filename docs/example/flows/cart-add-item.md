...
1. **client** → **shop.cart** — addItem
   `cart.v1/addItem` · [`examples/shop/cart/src/infrastructure/transport/http/basket/handlers.ts:43`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/cart/src/infrastructure/transport/http/basket/handlers.ts#L43) · Seen running in examples/shop/cart/telemetry/traces.jsonl (3 traces).
<a id="step-s2"></a>
