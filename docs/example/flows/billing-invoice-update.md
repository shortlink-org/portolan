...
- **Id:** `flow.billing-invoice-update`
- **Owner:** [shop](../shop/README.md)
- **Trigger:** `http` · PUT /v1/invoices/{id}/
...
<a id="step-s1"></a>
1. **client** → **shop.billing** — invoice_update
   `shop.billing.invoices/invoice_update` · status: declared · [`examples/shop/billing/invoices/views.py:10`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/billing/invoices/views.py#L10)
