...
| [Shipment](aggregates/shipment.md) | `Shipment` | 5 commands | 2 queries | 6 events |
...
| --- | --- | --- | --- |
| `payments.v1.PaymentService/Capture` | [payments.ledger](../../payments/ledger/README.md) | declared | [`examples/shop/delivery/core/src/infrastructure/ledger/proto/payments/v1/payments.proto`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/delivery/core/src/infrastructure/ledger/proto/payments/v1/payments.proto) |
...
| [`ShipmentCreated`](aggregates/shipment.md#event-delivery-core-shipment-shipmentcreated) | v1 |
...
| `npm run gen` | `buf generate src/infrastructure/transport/grpc/shipment/proto -o src/infrastructure/transport/grpc/shipment/gen && buf generate src/infrastructure/transport/grpc/route/proto -o src/infrastructure/transport/grpc/route/gen && buf generate src/infrastructure/oms/proto -o src/infrastructure/oms/gen && buf generate src/infrastructure/ledger/proto -o src/infrastructure/ledger/gen` | [`examples/shop/delivery/core/package.json:11`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/delivery/core/package.json#L11) |
| `npm start` | `node dist/main.js` | [`examples/shop/delivery/core/package.json:12`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/delivery/core/package.json#L12) |
| `npm test` | `vitest run` | [`examples/shop/delivery/core/package.json:13`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/delivery/core/package.json#L13) |
