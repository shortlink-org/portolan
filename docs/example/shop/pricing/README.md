...
| Hostnames | Route | Gateway listener | Protocol | Backend Service | Evidence | Source |
| --- | --- | --- | --- | --- | --- | --- |
| `api.example.com` | `HTTPRoute shop/pricing` | `shop/shop#https` | `HTTPS:443` | `shop/pricing` | manifest | [`examples/shop/pricing/deploy/k8s/pricing.yaml`](https://github.com/shortlink-org/portolan/blob/main/examples/shop/pricing/deploy/k8s/pricing.yaml) |
