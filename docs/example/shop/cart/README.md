...
| --- | --- | --- | --- | --- | --- | --- |
| prod | `in-cluster / shop` | [`3a0ebab`](https://github.com/shortlink-org/portolan/commit/3a0ebab1f0a622dded389f09a8eba5671fd8fd93) | `main` | kustomize | `ghcr.io/shortlink-org/cart:2.1.0` | [shop-cart-prod](https://argocd.example.com/applications/argocd/shop-cart-prod) |
| staging | `staging-eu / shop` | [`3a0ebab`](https://github.com/shortlink-org/portolan/commit/3a0ebab1f0a622dded389f09a8eba5671fd8fd93) | `main` | kustomize | `ghcr.io/shortlink-org/cart:2.2.0-rc.1` | [shop-cart-staging](https://argocd.example.com/applications/argocd/shop-cart-staging) |
