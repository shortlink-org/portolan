...
//
// `data__catalog.json` carries no stamp, exactly as its original does not: a
// file no plugin produces is generated by nobody, and freezing a provenance
// somebody typed would freeze the one shape the merge is written to ignore.
