...
export function CatalogApp() {
  // A catalog that failed validation is the catalog app's whole answer. The
  // public landing page is routed before this module is loaded.
  if (catalogError) {
    return <CatalogFailure error={catalogError} />;
  }
